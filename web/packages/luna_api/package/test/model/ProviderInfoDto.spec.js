...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LunaApi.ProviderInfoDto();
  });
  ...
  describe('ProviderInfoDto', function() {
    it('should create an instance of ProviderInfoDto', function() {
      // uncomment below and update the code to test ProviderInfoDto
      //var instance = new LunaApi.ProviderInfoDto();
      //expect(instance).to.be.a(LunaApi.ProviderInfoDto);
    });
