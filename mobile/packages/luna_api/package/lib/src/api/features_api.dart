...
class FeaturesApi {
  ...
  Future<Response<GetFeatureListResultDto>> featuresGet({ 
    String? providerName,
    String? providerKey,
    ...
    try {
      const _responseType = FullType(GetFeatureListResultDto);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> featuresUpdate({ 
    String? providerName,
    String? providerKey,
    ...
    try {
      ...
      _bodyData = updateFeaturesDto == null ? null : _serializers.serialize(updateFeaturesDto, specifiedType: _type);
