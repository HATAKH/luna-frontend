...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LunaApi.UpdateProfileDto();
  });
  ...
  describe('UpdateProfileDto', function() {
    it('should create an instance of UpdateProfileDto', function() {
      // uncomment below and update the code to test UpdateProfileDto
      //var instance = new LunaApi.UpdateProfileDto();
      //expect(instance).to.be.a(LunaApi.UpdateProfileDto);
    });
