...
import 'package:luna_api/src/api_util.dart';
...
class TenantApi {
  ...
  Future<Response<TenantDto>> tenantCreate({ 
    ...
    try {
      ...
      _bodyData = tenantCreateDto == null ? null : _serializers.serialize(tenantCreateDto, specifiedType: _type);
    ...
    try {
      const _responseType = FullType(TenantDto);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> tenantDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> tenantDeleteDefaultConnectionString({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [TenantDto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TenantDto>> tenantGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> tenantGetDefaultConnectionString({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PagedResultDtoOfTenantDto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PagedResultDtoOfTenantDto>> tenantGetList({ 
    String? filter,
    String? sorting,
    int? skipCount,
    int? maxResultCount,
    ...
    PagedResultDtoOfTenantDto _responseData;

    try {
      const _responseType = FullType(PagedResultDtoOfTenantDto);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as PagedResultDtoOfTenantDto;
    ...
    return Response<PagedResultDtoOfTenantDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [TenantDto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TenantDto>> tenantUpdate({ 
    required String id,
    ...
    try {
      ...
      _bodyData = tenantUpdateDto == null ? null : _serializers.serialize(tenantUpdateDto, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> tenantUpdateDefaultConnectionString({ 
    required String id,
