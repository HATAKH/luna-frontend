...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LunaApi.IdentityRoleCreateDto();
  });
  ...
  describe('IdentityRoleCreateDto', function() {
    it('should create an instance of IdentityRoleCreateDto', function() {
      // uncomment below and update the code to test IdentityRoleCreateDto
      //var instance = new LunaApi.IdentityRoleCreateDto();
      //expect(instance).to.be.a(LunaApi.IdentityRoleCreateDto);
    });
