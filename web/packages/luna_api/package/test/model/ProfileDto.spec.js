...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LunaApi.ProfileDto();
  });
  ...
  describe('ProfileDto', function() {
    it('should create an instance of ProfileDto', function() {
      // uncomment below and update the code to test ProfileDto
      //var instance = new LunaApi.ProfileDto();
      //expect(instance).to.be.a(LunaApi.ProfileDto);
    });
