...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LunaApi.TenantUpdateDto();
  });
  ...
  describe('TenantUpdateDto', function() {
    it('should create an instance of TenantUpdateDto', function() {
      // uncomment below and update the code to test TenantUpdateDto
      //var instance = new LunaApi.TenantUpdateDto();
      //expect(instance).to.be.a(LunaApi.TenantUpdateDto);
    });
