...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LunaApi.IdentityRoleDto();
  });
  ...
  describe('IdentityRoleDto', function() {
    it('should create an instance of IdentityRoleDto', function() {
      // uncomment below and update the code to test IdentityRoleDto
      //var instance = new LunaApi.IdentityRoleDto();
      //expect(instance).to.be.a(LunaApi.IdentityRoleDto);
    });
