...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LunaApi.ObjectExtensionsDto();
  });
  ...
  describe('ObjectExtensionsDto', function() {
    it('should create an instance of ObjectExtensionsDto', function() {
      // uncomment below and update the code to test ObjectExtensionsDto
      //var instance = new LunaApi.ObjectExtensionsDto();
      //expect(instance).to.be.a(LunaApi.ObjectExtensionsDto);
    });
