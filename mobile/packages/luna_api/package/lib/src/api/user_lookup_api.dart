...
class UserLookupApi {
  ...
  Future<Response<UserData>> userLookupFindById({ 
    required String id,
  ...
  /// Returns a [Future] containing a [Response] with a [UserData] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserData>> userLookupFindByUserName({ 
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<int>> userLookupGetCount({ 
    String? filter,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListResultDtoOfUserData] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ListResultDtoOfUserData>> userLookupSearch({ 
    String? filter,
    String? sorting,
    int? skipCount,
    int? maxResultCount,
    ...
    ListResultDtoOfUserData _responseData;

    try {
      const _responseType = FullType(ListResultDtoOfUserData);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as ListResultDtoOfUserData;
    ...
    return Response<ListResultDtoOfUserData>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
