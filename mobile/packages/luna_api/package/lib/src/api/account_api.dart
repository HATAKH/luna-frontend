...
class AccountApi {
  ...
  Future<Response<IdentityUserDto>> accountRegister({ 
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> accountResetPassword({ 
    ...
    try {
      ...
      _bodyData = resetPasswordDto == null ? null : _serializers.serialize(resetPasswordDto, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> accountSendPasswordResetCode({ 
    ...
    try {
      ...
      _bodyData = sendPasswordResetCodeDto == null ? null : _serializers.serialize(sendPasswordResetCodeDto, specifiedType: _type);
