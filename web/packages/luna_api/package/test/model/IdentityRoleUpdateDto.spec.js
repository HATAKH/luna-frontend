...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LunaApi.IdentityRoleUpdateDto();
  });
  ...
  describe('IdentityRoleUpdateDto', function() {
    it('should create an instance of IdentityRoleUpdateDto', function() {
      // uncomment below and update the code to test IdentityRoleUpdateDto
      //var instance = new LunaApi.IdentityRoleUpdateDto();
      //expect(instance).to.be.a(LunaApi.IdentityRoleUpdateDto);
    });
